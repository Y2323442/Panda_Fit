...
class User(db.Model):
    ...
    weekly_workout_count = db.Column(db.Integer, default=0)
    daily_workout_minutes = db.Column(db.Integer, default=0)
    ...
    def to_dict(self):
        return {
            ...
            "weeklyWorkoutCount": self.weekly_workout_count,
            "dailyWorkoutMinutes": self.daily_workout_minutes,
